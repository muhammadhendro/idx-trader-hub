...
import { ArrowUpRight, ArrowDownRight, BarChart3, Search } from 'lucide-react';

const Index = () => {
  const totalVolume = MOCK_STOCKS.reduce((s, st) => s + st.volume, 0);
  const avgChange = MOCK_STOCKS.reduce((s, st) => s + st.changePercent, 0) / MOCK_STOCKS.length;
      ...
      <div className="space-y-4 animate-fade-in">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          ...
          <div className="glass-card p-4">
            ...
            <p className="text-xs text-muted-foreground mt-1">{MOCK_STOCKS.length} saham</p>
          </div>
          <div className="glass-card p-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          {/* Watchlist */}
          <div className="glass-card p-4">
            <h3 className="text-sm font-semibold text-foreground mb-3">Watchlist Populer</h3>
